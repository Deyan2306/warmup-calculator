...
export default function StepWorkSet({
  ...
  setWorkSets: React.Dispatch<React.SetStateAction<{ weight: number; reps: number }[]>>;
  nextStep: () => void;
  prevStep: () => void;
}) {
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <Input
          ...
          onChange={(e) =>
            setWorkSets([{ ...workSets[0], weight: parseFloat(e.target.value) || 0 }])
          }
          placeholder="Weight"
        ...
        <Input
          ...
          onChange={(e) =>
            setWorkSets([{ ...workSets[0], reps: parseFloat(e.target.value) || 0 }])
          }
          placeholder="Reps"
